<div id="dulciela-mini-cart" class="mini-cart-overlay">
    <div class="mini-cart-panel">
        ...
        <div class="mini-cart-content">
            ...
            <?php else : ?> <ul class="cart_list woocommerce-mini-cart"> <?php
                    ...
                    foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
                        ...
                        if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
                            // ... (todo tu código de producto va aquí, está perfecto) ...
                            ...
                            <li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
                                ...
                                <?php else : ?>
                                    <a href="<?php echo esc_url( $product_permalink ); ?>">
                                        <?php echo $thumbnail . $product_name; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscapoed ?>
                                    </a>
                                <?php endif; ?>
                ...
                </ul> <p class="woocommerce-mini-cart__total total">
                    <?php
                    /**
